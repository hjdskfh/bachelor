"""
main_DLI_amp_sweep.py

Performs DLI amplitude sweep simulations for QKD, including database setup and data import routines.
"""
...
for idx, var_current in enumerate(arr_current):
    for i in range(times_per_n):
        ...
        #create simulation
        config = SimulationConfig(database, round=round_counter, mean_current=var_current, jitter=jitter, 
