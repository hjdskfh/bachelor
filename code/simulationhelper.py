...
class SimulationHelper:
    ...
    def classificator_identify_z(self, mask_x_short, value, total_sift_z_basis_short, detected_indices_z_det_z_basis, detected_indices_x_det_x_basis, index_where_photons_det_z, basis,  decoy, indices_z_long, get_original_indexing_z, get_original_indexing_x):
