...
config = SimulationConfig(database, seed=None, n_samples=10, n_pulses=4, batchsize=10, mean_voltage=1.8, mean_current=0.082111, voltage_amplitude=0.002, current_amplitude=0.0005,
                p_z_alice=0.9, #0.5,
                p_decoy= 0.3, #0.1,
