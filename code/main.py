...
config = SimulationConfig(database, seed=None, n_samples=20000, n_pulses=4, batchsize=1000, mean_voltage=0.969, mean_current=0.082111, voltage_amplitude=0.001, current_amplitude=0.0005,
