...
#create simulation
config = SimulationConfig(database, seed = seed, n_samples=100000, n_pulses=4, mean_voltage=1.0, mean_current=0.08, current_amplitude=0.02,
                 ...
                 fiber_attenuation=-3, detector_efficiency = 0.3, dark_count_frequency = 10, detection_time = 5e-10, detector_jitter = detector_jitter,
