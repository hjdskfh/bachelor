...
config = SimulationConfig(database, seed=None, n_samples=20, n_pulses=4, batchsize=10, mean_voltage=0.9825, mean_current=0.082111, voltage_amplitude=0.050, current_amplitude=0.0005,
