...
class SimulationConfig:
    def __init__(self, data, round = 1, seed = None, n_samples=20000, n_pulses=4, batchsize = 1000, mean_voltage=-1.755, mean_current=0.082111, voltage_amplitude=0.002, current_amplitude = 0.00041,
