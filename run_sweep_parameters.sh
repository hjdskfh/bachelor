...
#SBATCH --output=output_sweep.log               # Stdout log file
#SBATCH --error=error_sweep.log                 # Stderr log file
...
singularity exec --app dls /containers/stable/2025-02-19_1.img python ~/NeuMoQP/Programm/bachelor/code/main_sweep_parameters.py
